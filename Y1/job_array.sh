...
#SBATCH -C cpu
#SBATCH -q regular
#SBATCH -J Y1south_legacysim_run4
#SBATCH --mail-user=ar652820@ohio.edu
#SBATCH --mail-type=ALL
#SBATCH -t 01:00:00
#SBATCH -L SCRATCH
#SBATCH -o slurm_outputs/south/subrunlist%a_south_4_%A.out
#SBATCH -e slurm_outputs/south/subrunlist%a_south_4_%A.err
#SBATCH --image=adematti/legacysim:DR9
#SBATCH --array=1-483%10
