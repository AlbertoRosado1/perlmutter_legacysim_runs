# script to remove bricks already ran on DA02 footprint from bricklists, only works for first bricklist
import argparse
import os
import numpy as np
...
fn_Y1 = os.path.join(f'/global/homes/a/arosado/perlmutter_legacysim_runs/Y1/bricklist_{opt.run}.txt')
